---
title: Git 命令分类
slug: /tech/tools/git/git-command-type
tags: [git]
...
![img](https://picgo-starry.oss-cn-beijing.aliyuncs.com/img/note/tech/tools/github/dataflow.png)
![img](https://picgo-starry.oss-cn-beijing.aliyuncs.com/img/command-picture.png)
